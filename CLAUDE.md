...
reference/myharmony-core-model.mmd
...
reference/myharmony-entities.md every service contract by area with its field count, 470 of them.
...
make myharmony-model
                   check the drawn model against reference/myharmony-model.json, the diagram and the
