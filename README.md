...
Fifteen of the twenty base slots are named and every slot from 2 to 19 has a located firmware
...
the point falls in. Only base slot 2 is now neither named nor NULL. A config
