...
six until 29 August 2026. `PROTOCOL` carries the **architecture** rather than a protocol version,
and a config read off a remote has no header and therefore states none of the six. Section 225.
