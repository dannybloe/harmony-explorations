...
export const PROTOCOLS: readonly StatedProtocol[] = [
  { family: 'Toshiba 32 Bit', periodNs: 26315, header: [8990, 4490], flat: 568, zero: 552, one: 1662, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [568] }, { pad: 0 }, { words: [8990, -2230, 568, -96078] }], total: 215736 }, tailExact: 622, held: { items: [{ words: [8990, -2230, 568, -96078] }] }, heldExact: 517, heldOf: 517, codes: 622, exact: 622, spread: 0, source: 'compiled' },
  { family: 'Sharp 48 Bit 2', periodNs: 26315, header: [3364, 1682], flat: 408, zero: 431, one: 1272, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [408, -73611] }, { copy: 'full' }, { words: [408, -73611] }, { copy: 'full' }, { words: [408, -73612] }] }, tailExact: 345, held: { items: [{ copy: 'full' }, { words: [408, -73612] }] }, heldExact: 288, heldOf: 288, codes: 345, exact: 345, spread: 0, source: 'compiled' },
  ...
  { family: 'MemorexO1 32 Bit', periodNs: 26315, header: [8990, 4490], flat: 568, zero: 552, one: 1662, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [568] }, { pad: 0 }, { words: [8990, -2230, 568, -96078] }], total: 215736 }, tailExact: 81, held: { items: [{ words: [8990, -2230, 568, -96078] }] }, heldExact: 28, heldOf: 44, codes: 108, exact: 81, spread: 0.02, source: 'corpus' },
  ...
  { family: 'SharpO1 48 Bit', periodNs: 26315, header: [3364, 1682], flat: 408, zero: 431, one: 1272, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [408, -73611] }, { copy: 'full' }, { words: [408, -73611] }, { copy: 'full' }, { words: [408, -73612] }] }, tailExact: 33, held: { items: [{ copy: 'full' }, { words: [408, -73612] }] }, heldExact: 29, heldOf: 29, codes: 33, exact: 33, spread: 0, source: 'corpus' },
  ...
  { family: 'SharpO1 48 Bit', periodNs: 27472, header: [3480, 1730], flat: 425, zero: 450, one: 1320, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [425, -74800] }, { copy: 'full' }, { words: [425, -74800] }, { copy: 'full' }, { words: [425, -74801] }] }, tailExact: 12, held: { items: [{ copy: 'full' }, { words: [425, -74801] }] }, heldExact: 3, heldOf: 3, codes: 12, exact: 12, spread: 0, source: 'corpus' },
  ...
  { family: 'PanasonicV2 48 Bit', periodNs: 27472, header: [3480, 1730], flat: 425, zero: 450, one: 1320, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [425, -74801] }] }, tailExact: 4, held: { items: [{ copy: 'full' }, { words: [425, -74801] }] }, heldExact: 4, heldOf: 4, codes: 4, exact: 4, spread: 0, source: 'compiled' },
