...
export const PROTOCOLS: readonly StatedProtocol[] = [
  { family: 'Toshiba 32 Bit', periodNs: 26315, header: [8990, 4490], flat: 568, zero: 552, one: 1662, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [568] }, { pad: 0 }, { words: [8990, -2230, 568, -96078] }], total: 215736 }, tailExact: 622, codes: 622, exact: 622, spread: 0, source: 'compiled' },
  { family: 'Sharp 48 Bit 2', periodNs: 26315, header: [3364, 1682], flat: 408, zero: 431, one: 1272, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [408, -73611] }, { copy: 'full' }, { words: [408, -73611] }, { copy: 'full' }, { words: [408, -73612] }] }, tailExact: 345, codes: 345, exact: 345, spread: 0, source: 'compiled' },
  { family: 'Sharp 15 Bit 2', periodNs: 27027, header: [0, 0], flat: 260, firstMark: 270, zero: 790, one: 1850, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [260] }, { pad: 0 }, { copy: 'full', at: 1 }, { words: [260] }, { pad: 0 }, { copy: 'full' }, { words: [260] }, { pad: 0 }, { copy: 'full', at: 1 }, { words: [260] }, { pad: 0 }, { copy: 'full' }, { words: [260] }, { pad: 0 }, { copy: 'full', at: 1 }, { words: [260] }, { pad: 1 }], copyPeriod: 67792 }, tailExact: 184, codes: 220, exact: 220, spread: 0, source: 'compiled' },
  { family: 'Logitech 24 Bit', periodNs: 26315, header: [4000, 4500], flat: 400, zero: 1000, one: 500, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [400, -50001] }] }, tailExact: 206, codes: 217, exact: 217, spread: 0, source: 'both' },
  ...
  { family: 'MemorexO1 32 Bit', periodNs: 26315, header: [8990, 4490], flat: 568, zero: 552, one: 1662, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [568] }, { pad: 0 }, { words: [8990, -2230, 568, -96078] }], total: 215736 }, tailExact: 81, codes: 108, exact: 81, spread: 0.02, source: 'corpus' },
  { family: 'JVC 16 Bit', periodNs: 26315, header: [8400, 4200], flat: 500, zero: 500, one: 1600, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [500] }, { pad: 0 }, { copy: 'bare' }, { words: [500] }, { pad: 0 }, { copy: 'bare' }, { words: [500] }, { pad: 1 }], total: 147601 }, tailExact: 108, codes: 108, exact: 108, spread: 0, source: 'compiled' },
  { family: 'Magnavox 13 Bit', periodNs: 26315, biphase: { mark: 880, space: 900, lead: [{ mark: true, us: 880 }], setIsMark: true }, tail: { items: [{ copy: 'full' }, { words: [-32767, -32767, -26466] }, { copy: 'full' }, { words: [-32767, -32767, -26466] }, { copy: 'full' }, { words: [-32767, -32767, -26466, -1, 0] }] }, tailExact: 105, codes: 105, exact: 105, spread: 0, source: 'compiled' },
  { family: 'Sharp 15 Bit', periodNs: 27777, header: [0, 0], flat: 250, zero: 800, one: 1800, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [250] }, { pad: 0 }, { copy: 'full', at: 1 }, { words: [250] }, { pad: 0 }, { copy: 'full' }, { words: [250] }, { pad: 0 }, { copy: 'full', at: 1 }, { words: [250] }, { pad: 0 }, { copy: 'full' }, { words: [250] }, { pad: 0 }, { copy: 'full', at: 1 }, { words: [250] }, { pad: 1 }], copyPeriod: 65000 }, tailExact: 95, codes: 95, exact: 95, spread: 0, source: 'compiled' },
  { family: 'Sony 12 Bit', periodNs: 25000, header: [2400, 600], flat: 600, zero: 600, one: 1200, carries: 'mark', framePeriod: 45000, tail: { items: [{ copy: 'full' }, { pad: 0 }, { copy: 'full' }, { pad: 0 }, { copy: 'full' }, { pad: 1 }], total: 135001 }, tailExact: 59, codes: 59, exact: 59, spread: 0, source: 'both' },
  { family: 'Thomson 12 Bit Toggle', periodNs: 29411, header: [0, 0], flat: 470, zero: 2040, one: 4570, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [470] }, { pad: 0 }, { copy: 'full' }, { words: [470] }, { pad: 0 }, { copy: 'full' }, { words: [470] }, { pad: 1 }], total: 240001 }, tailExact: 59, codes: 59, exact: 59, spread: 0, source: 'compiled' },
  { family: 'RCAV1 LF 24 Bit', periodNs: 26178, header: [3970, 3980], flat: 490, zero: 2010, one: 1010, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [490, -8460] }, { copy: 'full' }, { words: [490, -8460] }, { copy: 'full' }, { words: [490, -8461] }] }, tailExact: 52, codes: 52, exact: 52, spread: 0, source: 'compiled' },
  { family: 'Philips RC5 13 Bit Toggle', periodNs: 27777, biphase: { mark: 889, space: 889, lead: [{ mark: true, us: 889 }], setIsMark: false }, tail: { items: [{ copy: 'full' }, { words: [-32767, -32767, -24255] }, { copy: 'full' }, { words: [-32767, -32767, -24255] }, { copy: 'full' }, { words: [-32767, -32767, -24255, -1, 0] }] }, tailExact: 51, codes: 51, exact: 51, spread: 0, source: 'compiled' },
  ...
  { family: 'JerroldO1 16 Bit', periodNs: 26315, header: [9000, 4520], flat: 495, zero: 2250, one: 4505, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [495] }, { pad: 0 }, { words: [9020, -2250, 495, -87236] }], total: 199001 }, tailExact: 47, codes: 47, exact: 47, spread: 0, source: 'compiled' },
  { family: 'Samsung 16 and 20 Bit', periodNs: 26315, header: [4500, 4480], flat: 495, zero: 500, one: 1495, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [495, -4495] }, { copy: 'bare', at: 1 }, { words: [495, -57501] }] }, tailExact: 36, codes: 46, exact: 46, spread: 0, source: 'compiled' },
  ...
  { family: 'Short 11 Bit 2', periodNs: 22727, header: [0, 0], flat: 228, zero: 8310, one: 5480, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [228] }, { pad: 0 }, { copy: 'full' }, { words: [228] }, { pad: 0 }, { copy: 'full' }, { words: [228] }, { pad: 1 }], total: 410236 }, tailExact: 42, codes: 42, exact: 42, spread: 0, source: 'compiled' },
  { family: 'PioneerO1 32 Bit Dual', periodNs: 25000, header: [8510, 4256], flat: 532, zero: 532, one: 1596, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [532, -35500] }, { copy: 'full', at: 1 }, { words: [532, -35500] }, { copy: 'full' }, { words: [532, -35500] }, { copy: 'full', at: 1 }, { words: [532, -35500] }, { copy: 'full' }, { words: [532, -35500] }, { copy: 'full', at: 1 }, { words: [532, -35501] }] }, tailExact: 40, codes: 40, exact: 40, spread: 0, source: 'compiled' },
  ...
  { family: 'MemorexV2 32 Bit', periodNs: 26595, header: [9000, 4500], flat: 560, zero: 560, one: 1680, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [560, -39100] }, { copy: 'full' }, { words: [560, -39100] }, { copy: 'full' }, { words: [560, -39101] }] }, tailExact: 38, codes: 38, exact: 38, spread: 0, source: 'compiled' },
  ...
  { family: 'Philips RECS80 11 Bit', periodNs: 26315, header: [0, 0], flat: 158, zero: 4902, one: 7442, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [158] }, { pad: 0 }, { copy: 'full' }, { words: [158] }, { pad: 0 }, { copy: 'full' }, { words: [158] }, { pad: 1 }], total: 364501 }, tailExact: 34, codes: 35, exact: 35, spread: 0, source: 'compiled' },
  { family: 'Pioneer 32 Bit Dual', periodNs: 25000, header: [8470, 4230], flat: 548, zero: 500, one: 1570, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [548, -25220] }, { copy: 'full', at: 1 }, { words: [548, -25220] }, { copy: 'full' }, { words: [548, -25220] }, { copy: 'full', at: 1 }, { words: [548, -25220] }, { copy: 'full' }, { words: [548, -25220] }, { copy: 'full', at: 1 }, { words: [548, -25221] }] }, tailExact: 32, codes: 34, exact: 34, spread: 0, source: 'compiled' },
  { family: 'SharpO1 48 Bit', periodNs: 26315, header: [3364, 1682], flat: 408, zero: 431, one: 1272, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [408, -73611] }, { copy: 'full' }, { words: [408, -73611] }, { copy: 'full' }, { words: [408, -73612] }] }, tailExact: 33, codes: 33, exact: 33, spread: 0, source: 'corpus' },
  { family: 'Videocrypt 11 Bit Toggle', periodNs: 30303, header: [0, 0], flat: 500, firstMark: 480, zero: 5282, one: 8150, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [500] }, { pad: 0 }, { copy: 'full' }, { words: [500] }, { pad: 0 }, { copy: 'full' }, { words: [500] }, { pad: 1 }], total: 413209 }, tailExact: 32, codes: 32, exact: 32, spread: 0, source: 'compiled' },
  { family: 'Pioneer 32 Bit', periodNs: 25000, header: [8470, 4230], flat: 548, zero: 500, one: 1570, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [548, -25220] }, { copy: 'full' }, { words: [548, -25220] }, { copy: 'full' }, { words: [548, -25221] }] }, tailExact: 9, codes: 19, exact: 19, spread: 0, source: 'both' },
  { family: 'Sony 20 Bit', periodNs: 25000, header: [2400, 600], flat: 600, zero: 600, one: 1200, carries: 'mark', framePeriod: 45000, tail: { items: [{ copy: 'full' }, { pad: 0 }, { copy: 'full' }, { pad: 0 }, { copy: 'full' }, { pad: 1 }], total: 135001 }, tailExact: 14, codes: 14, exact: 14, spread: 0, source: 'compiled' },
  { family: 'Sony 15 Bit', periodNs: 25000, header: [2400, 600], flat: 600, zero: 600, one: 1200, carries: 'mark', framePeriod: 45000, tail: { items: [{ copy: 'full' }, { pad: 0 }, { copy: 'full' }, { pad: 0 }, { copy: 'full' }, { pad: 1 }], total: 135001 }, tailExact: 12, codes: 12, exact: 12, spread: 0, source: 'both' },
  { family: 'SharpO1 48 Bit', periodNs: 27472, header: [3480, 1730], flat: 425, zero: 450, one: 1320, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [425, -74800] }, { copy: 'full' }, { words: [425, -74800] }, { copy: 'full' }, { words: [425, -74801] }] }, tailExact: 12, codes: 12, exact: 12, spread: 0, source: 'corpus' },
  { family: 'Memorex 32 Bit', periodNs: 26315, header: [9000, 4500], flat: 600, zero: 500, one: 1600, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [600, -43001] }] }, tailExact: 8, codes: 8, exact: 8, spread: 0, source: 'compiled' },
  { family: 'PioneerO1 32 Bit', periodNs: 25000, header: [8510, 4256], flat: 532, zero: 532, one: 1596, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [532, -35500] }, { copy: 'full' }, { words: [532, -35500] }, { copy: 'full' }, { words: [532, -35501] }] }, tailExact: 7, codes: 7, exact: 7, spread: 0, source: 'compiled' },
  { family: 'PanasonicV2 48 Bit', periodNs: 27472, header: [3480, 1730], flat: 425, zero: 450, one: 1320, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [425, -74801] }] }, tailExact: 4, codes: 4, exact: 4, spread: 0, source: 'compiled' },
  { family: 'Pioneer 32 Bit 2', periodNs: 25000, header: [8470, 4230], flat: 548, zero: 500, one: 1570, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [548, -25220] }, { copy: 'full', at: 1 }, { words: [548, -25220] }, { copy: 'full', at: 1 }, { words: [548, -25220] }, { copy: 'full', at: 1 }, { words: [548, -25221] }] }, tailExact: 3, codes: 3, exact: 3, spread: 0, source: 'compiled' },
  { family: 'MemorexV2 32 Bit Dual', periodNs: 26315, header: [9000, 4500], flat: 560, oneMark: 594, zero: 594, one: 1725, carries: 'space', tail: { items: [{ copy: 'full' }, { words: [594, -33580] }, { copy: 'full', at: 1 }, { words: [594, -35740] }, { copy: 'full' }, { words: [594, -33580] }, { copy: 'full', at: 1 }, { words: [594, -35740] }, { copy: 'full' }, { words: [594, -33580] }, { copy: 'full', at: 1 }, { words: [594, -35741] }] }, tailExact: 2, codes: 2, exact: 2, spread: 0, source: 'compiled' },
