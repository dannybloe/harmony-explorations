...
const ACCOUNTED: readonly [string, number, number][] = [
  ['h700_config', 859857, 979184],
  ['h700_config_2', 859868, 979242],
  ['h600_config', 637456, 738149],
  ['h525_config', 11044, 78486],
  ['one_config', 801264, 1672832],
  ['one_config_unprogrammed', 671252, 1232237],
  ['arch8_config_a', 356508, 444256],
  ['arch8_config_b', 303715, 470619],
  ['arch8_config_c', 314608, 490704],
  ['arch8_config_d', 314712, 492150],
