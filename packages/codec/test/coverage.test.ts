...
const ACCOUNTED: readonly [string, number, number][] = [
  ['h700_config', 254476, 979184],
  ['h700_config_2', 254476, 979242],
  ['h600_config', 181107, 738149],
  ['h525_config', 6933, 78486],
  ['one_config', 121775, 1672832],
  ['one_config_unprogrammed', 83116, 1232237],
  ['arch8_config_a', 69493, 444256],
  ['arch8_config_b', 57974, 470619],
  ['arch8_config_c', 61766, 490704],
  ['arch8_config_d', 61846, 492150],
