...
const ACCOUNTED: readonly [string, number, number][] = [
  ['h700_config', 960670, 979184],
  ['h700_config_2', 960681, 979242],
  ['h600_config', 728746, 738149],
  ['h525_config', 39085, 78486],
  ['one_config', 1639216, 1672832],
  ['one_config_unprogrammed', 1214376, 1232237],
  ['arch8_config_a', 419595, 444256],
  ['arch8_config_b', 443293, 470619],
  ['arch8_config_c', 461662, 490704],
  ['arch8_config_d', 463040, 492150],
  ['h600_safemode_gspm', 6535, 7115],
  ['h700_gspm', 6535, 7115],
  ['h650_safemode_gspm', 6535, 7115],
];
