...
const REBUILT: readonly [string, number, number][] = [
  ...
  ['h525_config', 49238, 29248],
  ['h525_config_2', 27848, 23347],
  ['h525_safemode_ahcm', 5860, 9199],
  ['arch8_config_a', 96458, 347798],
  ['arch8_config_b', 175570, 295049],
  ['arch8_config_c', 187644, 303060],
  ['arch8_config_d', 189002, 303148],
  ['one_config', 224763, 1448069],
  ['one_config_unprogrammed', 68444, 1163793],
  ['h600_config', 209376, 528773],
  ['h700_config', 256197, 722987],
  ['h700_config_2', 256225, 723017],
  ['one_spare_before_sync', 68444, 1163793],
  ['one_spare_after_sync', 141936, 1184628],
];
