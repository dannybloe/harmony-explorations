...
const REBUILT: readonly [string, number, number][] = [
  ['one34_region2', 2365, 6522],
  ['one_safemode', 2365, 6522],
  ['h700_gspm', 1967, 5144],
  ['h600_safemode_gspm', 1967, 5144],
  ['h650_safemode_gspm', 1967, 5144],
  ['h525_config', 47874, 30608],
  ['h525_config_2', 26818, 24373],
  ['h525_safemode_ahcm', 5411, 7976],
  ['arch8_config_a', 96139, 348064],
  ['arch8_config_b', 175047, 295507],
  ['arch8_config_c', 187132, 303504],
  ['arch8_config_d', 188490, 303592],
  ['one_config', 224172, 1448645],
  ['one_config_unprogrammed', 68045, 1164177],
  ['h600_config', 208960, 529185],
  ['h700_config', 255605, 723575],
  ['h700_config_2', 255633, 723605],
  ['one_spare_before_sync', 68045, 1164177],
  ['one_spare_after_sync', 141579, 1184970],
];
