...
const REBUILT: readonly [string, number, number][] = [
  ['one34_region2', 2368, 6534],
  ['one_safemode', 2368, 6534],
  ['h700_gspm', 1971, 5144],
  ['h600_safemode_gspm', 1971, 5144],
  ['h650_safemode_gspm', 1971, 5144],
  ['h525_config', 47878, 30608],
  ['h525_config_2', 26822, 24373],
  ['h525_safemode_ahcm', 5415, 7976],
  ['arch8_config_a', 96192, 348064],
  ['arch8_config_b', 175112, 295507],
  ['arch8_config_c', 187200, 303504],
  ['arch8_config_d', 188558, 303592],
  ['one_config', 224175, 1448657],
  ['one_config_unprogrammed', 68048, 1164189],
  ['h600_config', 208964, 529185],
  ['h700_config', 255609, 723575],
  ['h700_config_2', 255637, 723605],
  ['one_spare_before_sync', 68048, 1164189],
  ['one_spare_after_sync', 141582, 1184982],
];
