...
const CONTAINERS = [
  ...
  'h300_config',
  // And that Harmony 300 programmed, section 265, which is the second before and after pair on one
  // remote and the first arch 16 container whose infrared table is completely full.
