...
| `Exact on all sixteen samples` | section 117 | said of the base recovery, and it is not exact: the corpus has 24 containers and one of them defeats it. The anchored recovery is the one that holds on all 24 |
