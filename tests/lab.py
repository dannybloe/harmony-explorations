...
IMAGES = {
    ...
    # end 864 bytes before its own end marker, so the old marker based base recovery returned
    # 0x02FCA0 for a container linked at 0x030000, and its trailer checksum does not recompute
    # under any extent tried. It is what turned the circular base check into one that can fail.
    # Section 117.
